	...
	loadResource(options.path + 'font-awesome-4.3.0/css/font-awesome.min.css', 'stylesheet', function() {
		...
		if (!bowser.msie || bowser.version >= 9) {
			...
			if (typeof themes === "undefined") {
				themes = [
					{ name: '黑色', theme: 'css/theme/black.css' },
					{ name: '白色', theme: 'css/theme/white.css' },
					{ name: '联盟', theme: 'css/theme/league.css' },
					{ name: '天空', theme: 'css/theme/sky.css' },
					{ name: '米黄', theme: 'css/theme/beige.css' },
					{ name: '简洁', theme: 'css/theme/simple.css' },
					{ name: '衬线', theme: 'css/theme/serif.css' },
					{ name: '血色', theme: 'css/theme/blood.css' },
					{ name: '夜晚', theme: 'css/theme/night.css' },
					{ name: '月色', theme: 'css/theme/moon.css' },
					{ name: '日色', theme: 'css/theme/solarized.css' }
				];
			}
			...
			var buttons = 0;
			$('<li data-panel="Slides" data-button="' + (buttons++) + '" class="toolbar-panel-button"><span class="slide-menu-toolbar-label">幻灯片</span><br/><i class="fa fa-list"></i></li>')
				.appendTo(toolbar)
				.addClass('active-toolbar-button')
				.click(openPanel);

			if (themes) {
				$('<li data-panel="Themes" data-button="' + (buttons++) + '" class="toolbar-panel-button"><span class="slide-menu-toolbar-label">主题</span><br/><i class="fa fa-desktop"></i></li>')
					.appendTo(toolbar)
					.click(openPanel);
			}
			if (transitions) {
				$('<li data-panel="Transitions" data-button="' + (buttons++) + '" class="toolbar-panel-button"><span class="slide-menu-toolbar-label">转换</span><br/><i class="fa fa-arrows-h"></i></li>')
					.appendTo(toolbar)
					.click(openPanel);
            }
			...
			$('<li id="close"><span class="slide-menu-toolbar-label">关闭</span><br/><i class="fa fa-times"></i></li>')
				.appendTo(toolbar)
